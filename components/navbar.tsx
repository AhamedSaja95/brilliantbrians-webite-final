    ...
    >
      ...
      >
            ...
            <NavigationMenuList className="flex items-center space-x-1">
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link
                    href="/"
                    className="px-4 py-3 text-sm font-semibold text-gray-700 hover:text-[#d93b3b] hover:bg-gray-100 rounded-full transition-all duration-300 md:px-6"
                  >
                    Home
                  </Link>
                </NavigationMenuLink>
              ...
              <NavigationMenuItem>
                <NavigationMenuTrigger className="px-4 py-3 text-sm font-semibold text-gray-700 hover:text-[#d93b3b] hover:bg-gray-100 rounded-full transition-all duration-300 data-[state=open]:text-[#d93b3b] data-[state=open]:bg-gray-100 [&>svg]:hidden group md:px-6">
        ...
        <div className="flex items-center lg:hidden">
          <button
            className="relative inline-flex items-center justify-center rounded-full p-3 text-gray-700 hover:text-[#d93b3b] hover:bg-gray-100/50 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#d93b3b] focus:ring-offset-2 group"
            type="button"
      ...
      {isOpen && (
        <div
          id="mobile-menu"
          className={`lg:hidden bg-white/95 backdrop-blur-md shadow-xl ${
            isScrolled
        ...
        >
          <div className="navbar-container mx-auto py-6 px-4 md:px-6">
            <nav className="grid gap-2">
              <Link
                href="/"
                className="flex w-full items-center rounded-full p-4 text-sm font-medium text-gray-700 hover:text-[#d93b3b] hover:bg-gray-50 transition-colors duration-200"
              ...
              <div className="py-2">
                <div className="flex items-center gap-3 text-sm font-semibold text-gray-900 px-4 pb-3">
                  <svg
                ...
                <div className="grid gap-1 pl-4">
                  {tutoringPrograms.map((program) => (
                    <Link
                      key={program.title}
                      href={program.href}
                      className="flex w-full items-center rounded-full p-3 text-sm text-gray-600 hover:text-[#d93b3b] hover:bg-gray-50 transition-colors duration-200"
                      onClick={() => setIsOpen(false)}
                    >
                      <span className="flex items-center gap-2">
  ...
  return (
    <div {...props}>
      <NavigationMenuLink asChild>
        <Link
          href={href}
          className="block select-none space-y-3 rounded-2xl p-5 leading-none no-underline outline-none transition-all duration-300 hover:bg-gray-100 focus:bg-gray-100 group border border-transparent hover:border-gray-200/50"
        >
          <div className="flex items-center gap-3 text-sm font-semibold leading-none text-gray-800 group-hover:text-[#d93b3b] transition-colors duration-300">
            {Icon ? (
              <div className="p-2 bg-[#2151A1]/10 rounded-xl group-hover:bg-[#d93b3b]/10 transition-all duration-300">
                <Icon className="w-4 h-4 text-[#2151A1] group-hover:text-[#d93b3b] transition-colors duration-300" />
              </div>
            ) : (
              <div className="w-2 h-2 bg-[#2151A1] rounded-full group-hover:bg-[#d93b3b] transition-colors duration-300"></div>
            )}
            {title}
          </div>
          <p className="line-clamp-2 text-sm leading-relaxed text-gray-600 group-hover:text-gray-700 transition-colors duration-300">
            {children}
          </p>
        </Link>
      </NavigationMenuLink>
